                ...
                $(function(){
                    ...
                    $('#signbtn').click(function(){
                        ...
                        $.post("/Api/isEmailUrl", { email:email},function(data){
                            if (data.status == 'success') {
                                ...
                                $.each(data.data,function(k,v){
                                        _html += '<tr><td>'+ k +'</td><td>'+v.name+'</td><td>'+v.url+'</td><td>[<a href="javascript:;" data-id="'+v.id+'" class="update-btn">编辑</a>][<a href="javascript:;" data-id="'+v.id+'" class="delete-btn">删除</a>]</td></tr>';
                                });
                                $("#url-table").append(_html);
                                $(".linklist").show();
                            }else{
                                alertWind(data.msg);
                            }
                        ...
                        $(document).on('click','.update-btn',function () {
                            ...
                            $.post("/Api/getUpdateUrlOne", { id: id},function(data){
                                      if (data.status == 'success') {
